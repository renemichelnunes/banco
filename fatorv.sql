...
--
-- Name: fatorv; Type: DATABASE; Schema: -; Owner: fatorv
--

CREATE DATABASE fatorv WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'pt_BR.UTF-8';


ALTER DATABASE fatorv OWNER TO fatorv;
